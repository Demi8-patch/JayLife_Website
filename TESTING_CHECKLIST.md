This file has moved to `docs/TESTING_CHECKLIST.md`.

Please edit the checklist in `docs/TESTING_CHECKLIST.md` and open a PR for substantive changes.

(Root-level docs are deprecated — see `.github/copilot-instructions.md` for guidance.)
