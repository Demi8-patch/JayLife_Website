...
```css
--color-acid: #bfff00 /* Primary CTA */ --color-cream: #faf9f5 /* Background */
  --color-charcoal: #1a1a1a /* Text */ --color-muted: #68809a /* Secondary */ --color-coral: #ff6f61
  /* Errors/Urgency */ --color-lavender: #e6e6fa /* Info accent */;
```
...
_Update this file when: design decisions made, components added/removed, issues resolved, or session context changes._
