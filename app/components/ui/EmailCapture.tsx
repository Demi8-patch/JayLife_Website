  ...
  return (
    <section className="bg-acid/10 py-16 md:py-20">
      <div className="max-w-2xl mx-auto px-5 md:px-10 text-center">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 mb-4">
            <input
              ...
              required
              className="flex-1 px-5 py-4 rounded-xl border border-charcoal/20 focus:outline-none focus:ring-2 focus:ring-acid focus:border-transparent text-charcoal placeholder:text-charcoal/40"
            />
            <button
              type="submit"
              className="bg-charcoal text-white px-8 py-4 rounded-xl font-semibold hover:bg-acid transition-colors shadow-sm whitespace-nowrap"
            >
              Get {discount}
            </button>
          </form>
        ...
        <p className="text-xs text-charcoal/50 flex items-center justify-center gap-1">
