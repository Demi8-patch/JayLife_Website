    ...
    return (
        <>
            <nav className="fixed top-0 left-0 right-0 z-[50] flex items-center justify-between px-6 py-4 bg-warm-sunrise-charcoal/95 backdrop-blur border-b-2 border-warm-sunrise-lime">
                {/* Logo */}
                <Link to="/" className="text-2xl font-bold tracking-tighter uppercase font-display text-warm-sunrise-lime hover:text-warm-sunrise-offwhite transition-colors">
                ...
                >
                    {isOpen ? (
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M4 6h16M4 12h16M4 18h16" /></svg>
                    )}
                </button>
            </nav>
