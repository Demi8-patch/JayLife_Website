            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
                    ...
                    <div className="flex flex-col justify-end">
                        <p className="mb-4 text-warm-sunrise-blush font-medium">Join the insider list. No spam, just vibes.</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t-2 border-warm-sunrise-offwhite/10 pt-12">
                    {['Shop', 'Focus', 'Calm', 'Gut', 'Glow', 'Move'].map((item) => (
                        <div key={item}>
                            <Link to="/rituals" className="block text-xl font-bold uppercase hover:text-warm-sunrise-lime mb-2">{item}</Link>
                        </div>
                    ))}
                    <div className="col-span-2 md:col-span-1">
                        <h4 className="text-sm text-warm-sunrise-lime font-mono mb-4 uppercase">Support</h4>
                        <Link to="/account" className="block text-sm hover:text-warm-sunrise-lime mb-2">My Account</Link>
                        <Link to="/faq" className="block text-sm hover:text-warm-sunrise-lime mb-2">FAQ</Link>
                        <Link to="/contact" className="block text-sm hover:text-warm-sunrise-lime mb-2">Contact</Link>
                    </div>
                </div>
